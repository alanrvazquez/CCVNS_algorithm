function [ result, combdes] = Parallel_CCVNSBfour( desupper, pardeslower, maxiter)

% PARALLEL version of the CC/VNS algorithm for optimizing the B4 value of 
...
%           optimized concatenated designs.
...
parfor jj = 1:maxiter
    ...
    result(jj, 1) = Bfour(finaldes, twoproN, m+1); % Save the resulting best B4 value.
