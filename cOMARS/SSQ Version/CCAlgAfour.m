function [objvalue, lowdes] = CCAlgAfour(desupper, lowdes, m, ncombtwo, nm, N)
...
objvalue = lcSOcorr([desupper; lowdes], ncombtwo, nm, N);
...
% Step 2 Improve
    for ii = 1:m
        ...
        % Evaluate design
        resvalue = lcSOcorr([desupper; lowdes], ncombtwo, nm, N);
        ...
        for jj = st1:m
            ...
            resvalueTwo = lcSOcorr([desupper; lowdes], ncombtwo, nm, N); % Positive Version     
            lowdes(:, ii) = -1*lowdes(:, ii);
            resvalue = lcSOcorr([desupper; lowdes], ncombtwo, nm, N); % Negative Version
